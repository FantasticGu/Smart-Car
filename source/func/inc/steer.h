...
#define STEER_LEFT      1150     //舵机摆角左极限  这里的值是用于测试的，大家根据自己的舵机更改
#define STEER_MIDDLE    990     //舵机摆角中值
#define STEER_RIGHT     850   //舵机摆角右极限  
...
#define  STEER_INIT_VAL 990   //舵机初始值，精度1/10000  即1200/10000  = 12%
